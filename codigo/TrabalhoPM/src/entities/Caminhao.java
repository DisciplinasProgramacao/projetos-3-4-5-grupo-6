...
public class Caminhao extends AbstractVehicle{

	private Double consumo;	
	
	public Caminhao(String modelo, String placa, Integer capacidadeTanque, Double valorVenda, Double quilometragem) {
